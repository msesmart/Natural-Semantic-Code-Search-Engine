 ...
 *  Version:	Feb.15 2016	change the algorithm to filter the stopwords and remove the words whose length exceed ten.
				...
				Mar.22 2016 improve the efficiency of parsing descriptions from github API and accept more kinds of API return. This
 */
...
public class PreprocessForWord2Vec_loadDescriptions {
	...
	public PreprocessForWord2Vec_loadDescriptions(){
	...
	public void removeBigProject(final double upLimitProjectSize, String folder) {
  		...
  		for(File f : dir.listFiles()){
  			...
  			if(f.isDirectory()) {
  				...
  				if(descriptionExist(f.getAbsolutePath())) {
  					...
  					descriptionSb.append(loadDescription(f.getAbsolutePath()));
...
//	  try {
//	  	String[] preproFiles = {"description.prepro_rs", "re.prepro_rs", "code.prepro_rs"};
//  	  File dir = new File(folder);
...
//	}
	...
	public static void main(String[] args) throws IOException{
		...
		PreprocessForWord2Vec_loadDescriptions preprocess = new PreprocessForWord2Vec_loadDescriptions();
		//preprocess.removeProjectsWithNoReadme(args[0]);
		//preprocess.removeBigProject(300.0, args[0]);
		...
		preprocess.generateStopWords("english.stop", 0.1);
